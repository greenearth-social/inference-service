    ...
    with torch.inference_mode():
        match entry.model_type:
            case "user-tower":
                ...
                author_indices = _get_author_indices_from_dids(req.history_author_dids)
                ...
                history_mask = _tensor_from_nested_list("history_mask", history_mask_padded, torch.int64, entry.device)
